...
class Example(MDApp):
    ...
    def set_item(self, i):
        ...
        if i == "ahhhhh":
            ...
            sound = SoundLoader.load("Audio/ahhhhh.mp3")
            sound.play()
        elif i == "amongus":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=28]  Sound\n[/font][/size]" + "  amongus"
            sound = SoundLoader.load("Audio/amongus.mp3")
            sound.play()
        elif i == "arpeggio":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=28]  Sound\n[/font][/size]" + "  arpeggio"
            sound = SoundLoader.load("Audio/arpeggio.mp3")
            sound.play()
        elif i == "bell":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=28]  Sound\n[/font][/size]" + "  bell"
            sound = SoundLoader.load("Audio/bell.mp3")
            sound.play()
        elif i == "bongo":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=28]  Sound\n[/font][/size]" + "  bongo"
            sound = SoundLoader.load("Audio/bongo.mp3")
            sound.play()
        elif i == "chimes":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=28]  Sound\n[/font][/size]" + "  chimes"
            sound = SoundLoader.load("Audio/chimes.mp3")
            sound.play()
        elif i == "cute lame":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=28]  Sound\n[/font][/size]" + "  cute lame"
            sound = SoundLoader.load("Audio/cute_lame.mp3")
            sound.play()
        elif i == "default":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=28]  Sound\n[/font][/size]" + "  default"
            sound = SoundLoader.load("Audio/default.mp3")
            sound.play()
        elif i == "ding":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=28]  Sound\n[/font][/size]" + "ding"
            sound = SoundLoader.load("Audio/ding.mp3")
            sound.play()
        elif i == "ding dong":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=28]  Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]ding dong[/font]"
            sound = SoundLoader.load("Audio/ding dong.mp3")
            sound.play()
        elif i == "eager":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]eager[/font]"
            sound = SoundLoader.load("Audio/eager.mp3")
            sound.play()
        elif i == "good bad ugly":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]good bad ugly[/font]"
            sound = SoundLoader.load("Audio/good_bad_ugly.mp3")
            sound.play()
        elif i == "iphone":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]iphone[/font]"
            sound = SoundLoader.load("Audio/bongo.mp3")
            sound.play()
        elif i == "iphone ding":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]iphone ding[/font]"
            sound = SoundLoader.load("Audio/iphone_ding.mp3")
            sound.play()
        elif i == "lazer":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]lazer[/font]"
            sound = SoundLoader.load("Audio/lazer.mp3")
            sound.play()
        elif i == "lights":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]lights[/font]"
            sound = SoundLoader.load("Audio/lights.mp3")
            sound.play()
        elif i == "my name is jeff":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]my name is jeff[/font]"
            sound = SoundLoader.load("Audio/my_name_is_jeff.mp3")
            sound.play()
        elif i == "ohh no!!!":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]ohh no!!![/font]"
            sound = SoundLoader.load("Audio/ohh no!!!.mp3")
            sound.play()
        elif i == "old spice":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]old spica[/font]"
            sound = SoundLoader.load("Audio/old_spice.mp3")
            sound.play()
        elif i == "pulse":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]pulse[/font]"
            sound = SoundLoader.load("Audio/pulse.mp3")
            sound.play()
        elif i == "reliance home":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]reliance home[/font]"
            sound = SoundLoader.load("Audio/reliance_home.mp3")
            sound.play()
        elif i == "robot":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]robot[/font]"
            sound = SoundLoader.load("Audio/robot.mp3")
            sound.play()
        elif i == "samsung":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]samsung[/font]"
            sound = SoundLoader.load("Audio/samsung.mp3")
            sound.play()
        elif i == "shooting star":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]shooting star[/font]"
            sound = SoundLoader.load("Audio/shooting_star.mp3")
            sound.play()
        elif i == "sweet":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]sweet[/font]"
            sound = SoundLoader.load("Audio/sweet.mp3")
            sound.play()
        elif i == "tick":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]tick[/font]"
            sound = SoundLoader.load("Audio/tick.mp3")
            sound.play()
        elif i == "treasure":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]treasure[/font]"
            sound = SoundLoader.load("Audio/treasure.mp3")
            sound.play()
        elif i == "wisstle":
            self.root.ids.field.text = "[font=font/GothamMedium.ttf][size=30]Sound\n[/font][/size]" + "[font=font/33713_SerpentineBoldItalic.ttf]wisstle[/font]"
            sound = SoundLoader.load("Audio/wisstle.mp3")
            sound.play()
        self.menu.dismiss()
    def cave(self):
    ...
    def kmn(self):
        self.root.ids.images.source="images/kmn.jpeg"
        self.root.ids.images.opacity = 1
    def koko(self):
    ...
    def ocean_2(self):
        ...
        self.root.ids.images.opacity = 1
    def OIP(self):
        self.root.ids.images.source="images/OIP.jpeg"
        self.root.ids.images.opacity = 1
    def pb(self):
        self.root.ids.images.source="images/pb.jpg"
        self.root.ids.images.opacity = 1
    def red_space(self):
        self.root.ids.images.source="images/red_space.jpeg"
        self.root.ids.images.opacity = 1
    def snow(self):
